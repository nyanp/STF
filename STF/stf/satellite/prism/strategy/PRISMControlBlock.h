...
{
public:
	PRISMControlBlock() : ads_mode_(0), acs_mode_(0), obs_mode_(0) {}
	template<class T>
	PRISMControlBlock( devicedriver::OutputPort<typename T::Hold>* torque_source, T* torque_target)
		: ControlBlock( torque_source, torque_target){}
